...
public class SimetricoCifrar {
    ...
    public String cifrarTexto(String clave, String mensaje) {
        ...
        try {
            ...
            fileWriter(rutaDocs + "\\CashTracker\\Credentials.properties", combined);
    ...
    public static void main(String[] args) {
        SimetricoCifrar ejemploAES = new SimetricoCifrar();
        String mensajeCifradoMail = ejemploAES.cifrarTexto("Clave", "grupo5tartanga@zohomail.eu/CaraCactus23");
