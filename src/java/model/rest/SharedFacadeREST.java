...
public class SharedFacadeREST {
     ...
     */
    @GET
    @Path("findAllSharedByAccount/{id}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Shared> findAllSharedByAccount(@PathParam("id") Long id) throws SelectException {
        return si.findAllSharedByAccount(id);
    }
}
